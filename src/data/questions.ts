...
const questionPool: Question[] = [
 { id: 1, category: "Raciocínio lógico", question: "Qual número completa a sequência: 3, 9, 15, 21, ?", options: ["25", "27", "29", "33"], correctAnswer: 1, points: 10 },
  ...
  { id: 6, category: "Raciocínio lógico", question: "Se P → Q e não Q, então não P?", options: ["Verdadeiro", "Falso"], correctAnswer: 0, points: 15 },
  ...
  { id: 13, category: "Raciocínio lógico", question: "Se o Z é o último e o A é o primeiro, qual letra fica a meio?", options: ["M", "N", "O", "P"], correctAnswer: 1, points: 10 },
  ...
  { id: 16, category: "Raciocínio lógico", question: "Se 'CASA' é 1, 'CARRO' é 2 e 'NAVIO' é 3, o que é 'BICICLETA'?", options: ["3", "4", "5", "6"], correctAnswer: 0, points: 15 },
  ...
  { id: 23, category: "Raciocínio lógico", question: "Se 'SOL' é 3 e 'LUA' é 3, o que é 'ESTRELA'?", options: ["3", "5", "7", "9"], correctAnswer: 2, points: 10 },
  ...
  { id: 39, category: "Raciocínio lógico", question: "Qual palavra não pertence ao grupo: Dó, Ré, Mi, Sol, Fá?", options: ["Dó", "Ré", "Mi", "Fá"], correctAnswer: 3, points: 10 },
  ...
  { id: 43, category: "Raciocínio lógico", question: "Qual o próximo número na sequência: 1, 2, 6, 24, ?", options: ["48", "96", "120", "144"], correctAnswer: 2, points: 15 },
  ...
  { id: 49, category: "Raciocínio lógico", question: "Se chove, a estrada fica molhada. A estrada está molhada. Conclusão: Choveu.", options: ["Verdadeiro", "Falso", "Provavelmente", "Não se pode inferir"], correctAnswer: 3, points: 15 },
  ...
  { id: 103, category: "Raciocínio matemático", question: "Sequência: 3, 7, 15, 31, ?", options: ["47", "61", "63", "67"], correctAnswer: 2, points: 15 },
  { id: 104, category: "Raciocínio matemático", question: "$20 - 5 \times 3 + 2 = $?", options: ["5", "7", "17", "47"], correctAnswer: 1, points: 10 },
  { id: 105, category: "Raciocínio matemático", question: "Qual número completa a sequência: 1, 8, 27, 64, ?", options: ["81", "100", "125", "216"], correctAnswer: 2, points: 10 },
  ...
  { id: 109, category: "Raciocínio matemático", question: "Complete: 4, 16, 64, ?", options: ["128", "256", "300", "512"], correctAnswer: 1, points: 15 },
  ...
  { id: 111, category: "Raciocínio matemático", question: "Quanto é $\\frac{2}{3} + \\frac{1}{6}$?", options: ["$\\frac{3}{9}$", "$\\frac{5}{6}$", "$\\frac{1}{2}$", "$\\frac{4}{6}$"], correctAnswer: 1, points: 15 },
  ...
  { id: 114, category: "Raciocínio matemático", question: "Sequência: 5, 20, 80, 320, ?", options: ["640", "1280", "1600", "2560"], correctAnswer: 2, points: 15 },
  ...
  { id: 117, category: "Raciocínio matemático", question: "Numa sala, $60 \\%$ dos alunos são raparigas. Se há $12$ rapazes, quantas raparigas há?", options: ["18", "20", "24", "30"], correctAnswer: 1, points: 15 },
  ...
  { id: 123, category: "Raciocínio matemático", question: "Qual o próximo número de Fibonacci: 1, 1, 2, 3, 5, 8, ?", options: ["10", "11", "12", "13"], correctAnswer: 3, points: 10 },
  ...
  { id: 144, category: "Raciocínio matemático", question: "Sequência: 1, 2, 3, 5, 8, ?", options: ["11", "12", "13", "14"], correctAnswer: 2, points: 15 },
  ...
  { id: 148, category: "Raciocínio matemático", question: "Se 3 trabalhadores constroem um muro em 10 dias, quantos dias demoram 6 trabalhadores?", options: ["3 dias", "5 dias", "10 dias", "20 dias"], correctAnswer: 1, points: 15 },
  { id: 149, category: "Raciocínio matemático", question: "Qual o próximo número na sequência: 0, 1, 1, 2, 4, 8, ?", options: ["10", "12", "15", "16"], correctAnswer: 3, points: 15 },
  ...
  { id: 196, category: "Raciocínio espacial", question: "Se o $1^{\\text{º}}$ andar é $3 \\text{ m}$ acima do rés-do-chão, e cada andar tem $3 \\text{ m}$, qual é a altura do $5^{\\text{º}}$ andar?", options: ["$12 \\text{ m}$", "$15 \\text{ m}$", "$18 \\text{ m}$", "$21 \\text{ m}$"], correctAnswer: 1, points: 15 },
  ...
  { id: 212, category: "Memória / atenção", question: "Observe: $100, 50, 25, 12.5$. O próximo número é?", options: ["6", "6.25", "7", "12"], correctAnswer: 1, points: 15 },
